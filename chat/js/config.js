/** @package AJAX_Chat* @author Sebastian Tschan* @copyright (c) Sebastian Tschan* @license GNU Affero General Public License* @link https://blueimp.net/ajax/*/
...
var ajaxChatConfig = {
	...
	bbCodeTags: new Array(
		'b','i','u','quote','code','color','url','img', 'youtube'
	),
	// Defines the list of allowed color codes:
	colorCodes: new Array(
		'silver','white','yellow','orange','navy','aqua','lime','olive','maroon','black','Aqua','Aquamarine','BurlyWood','CadetBlue','Chartreuse','Chocolate','Coral','CornflowerBlue','DarkGoldenRod','Darkorange','DarkRed','DarkSalmon','DarkSeaGreen','DeepSkyBlue','Gold','GoldenRod','GreenYellow','HotPink','Indigo','Khaki','LawnGreen','LightBlue','LightCoral','LightGreen','LightPink','LightSalmon','LightSeaGreen','LightSkyBlue','LightSlateGray','LimeGreen','MediumAquaMarine','MediumBlue','MediumOrchid','MediumSeaGreen','MediumTurquoise','MediumSpringGreen','MidnightBlue','OrangeRed','Orchid','PaleGreen','PaleTurquoise','Peru','Pink','Plum','PowderBlue','RosyBrown','Salmon','SandyBrown','SkyBlue','Teal','Tomato','Turquoise','Violet','YellowGreen'
	),
